  ...
  return (
    <>
      ...
      <div className="row m-0">
        <div
          className="container "
          style={{ marginTop: "100px", fontFamily: "" }}
        >
          <div className="row px-4 py-4 m-0">
            <div className="col ">
              ...
              <p className="mt-4">
                ...
                with their queries. Customers can get in touch with the support
                team through a variety of channels, including phone, email, and
                chat.
              </p>
              ...
              <div className="row mt-4 ">
                <div className="col-2  m-auto">
                  <i
                    className="bi bi-house fs-3 px-4 py-3 text-primary rounded box-shadow"
              ...
              <div className="row mt-4">
                <div className="col-2  m-auto">
                  <i
                    className="bi bi-headset fs-3 px-4 py-3 text-primary rounded box-shadow"
                    style={{ backgroundColor: "rgb(245, 248, 252)" }}
                  ></i>
                </div>
                <div className="col-10 ">
              ...
              <div className="row mt-4">
                <div className="col-2  m-auto">
                  <i
                    className="bi bi-envelope fs-3 px-4 py-3 text-primary rounded box-shadow"
                    style={{ backgroundColor: "rgb(245, 248, 252)" }}
                  ></i>
                </div>
                <div className="col-10 ">
                ...
                <div className="  p-5 box-shadow">
                  <form onSubmit={sendContactUs}>
                    <input
                      ...
                      className="fs-6 w-100 py-2 px-3"
                    />
                    <input
                      type="email"
                      value={email}
                      ...
                      className="fs-6 mt-4 w-100 py-2 px-3"
                    />
                    <input
                      type="Number"
                      required
