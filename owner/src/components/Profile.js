    ...
    <>
      ...
      <div className='row m-0 px-4 mb-5'>
        <div className='mt-5  text-center'>
          <img src="https://www.svgrepo.com/show/525577/user-circle.svg" className='w-25 mt-5 p-5 py-0' alt="" />
        </div>
        <hr className='my-1 text-dark border border-2 border-dark ' />

        <div className="row mt-3">
          <div className="col-3 ">

            <div className=' px-4'>
              <p className='py-2 ps-3 fw-medium border border-2 border-dark rounded rounded-5'>Profile</p>
              <p className='py-2 ps-3 fw-medium border border-2 border-dark rounded rounded-5'>Restaurant</p><hr className='border border-2 border-dark' />
