...
const emailSendMsg = async(req, res) => {
    await sendEmail("Regarding your issue in food point",req?.body?.email,req?.body?.msg)
    res.send({
        success:true,
    })
}
...
export {createContactUs,deleteMsg,alldata,emailSendMsg}